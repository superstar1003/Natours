...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3ViaGFzaDYxIiwiYSI6ImNraG0zczV4MDBib2Yyd3Q0Y3YwcXpoZWEifQ.Jf7d1bbsm4NP-EGBe35j_Q ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/subhash61/ckhm55i7w0nvm1apaz12xstav',
    scrollZoom: false // center: [-118.202377, 34.112523],
    // zoom: 10,
    // interactive: false
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51Hrzi0LOnIqRlpuA122OcF85Pya1x2JQgLWefdf2CifvKa6luUvNtaDK58IipZO1xHpVG5HxuOLJgi2V6u16m8BE00wcomgcYH');
            _context.prev = 1;
            _context.next = 4;
